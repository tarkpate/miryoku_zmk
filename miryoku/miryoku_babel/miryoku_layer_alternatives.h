...
U_NP,              &hm RALT U_NP,     &kp TAB,           &kp E,             &lt U_FUN ESC,     &kp RET,           &kp SPC,           &kp BSPC,          &hm RALT U_NP,     U_NP
...
U_NA,              &kp RALT,          &to U_NUM,         &to U_NAV,         U_NA,              &kp RET,           &kp BSPC,          &kp DEL,           U_NP,              U_NP
...
U_NA,              U_NA,              U_NA,              U_NA,              U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
U_NA,              &kp RALT,          &to U_SYM,         &to U_MOUSE,       U_NA,              U_BTN2,            U_BTN1,            U_BTN3,            U_NP,              U_NP
...
U_NA,              &kp RALT,          &to U_FUN,         &to U_MEDIA,       U_NA,              &kp C_STOP,        &kp C_PP,          &kp C_MUTE,        U_NP,              U_NP
...
U_NP,              U_NP,              &kp DOT,           &kp NUM_0,         &kp MINUS,         U_NA,              &to U_NUM,         &to U_NAV,         &kp RALT,          U_NA
...
U_NP,              U_NP,              &kp LPAR,          &kp RPAR,          &kp UNDER,         U_NA,              &to U_SYM,         &to U_MOUSE,       &kp RALT,          U_NA
...
U_NP,              U_NP,              &kp K_APP,         &kp SPC,           &kp TAB,           U_NA,              &to U_FUN,         &to U_MEDIA,       &kp RALT,          U_NA
...
U_NA,              U_NA,              U_NA,              U_NA,              U_NA,              &kp MINUS,         &kp NUM_5,         &kp NUM_6,         &kp ASTRK,         &kp SLASH,         \
U_NA,              &kp RALT,          &to U_SYM,         &to U_BNFRD,       U_NA,              &kp SPC,           &kp NUM_0,         &kp DOT,           U_NP,              U_NP
