...
&kp A,             &kp Z,             &kp E,             &kp R,             &kp T,             &kp Y,             &kp U,             &kp I,             &kp O,             &kp P,             \
&hm LGUI Q,        &hm LALT S,        &hm LCTRL D,       &hm LSHFT F,       &kp G,             &kp H,             &hm LSHFT J,       &hm LCTRL K,       &hm LALT L,        &hm LGUI M,        \
&lt U_BUTTON W,    &hm RALT X,        &kp C,             &kp V,             &lt U_FUN B,       &lt U_MEDIA N,     &kp COMMA,         &kp DOT,           &hm RALT SLASH,    &lt U_BUTTON SQT,  \
...
&kp Q,             &kp H,             &kp O,             &kp U,             &kp X,             &kp G,             &kp C,             &kp R,             &kp F,             &kp Z,             \
&hm LGUI Y,        &hm LALT I,        &hm LCTRL E,       &hm LSHFT A,       &kp DOT,           &kp D,             &hm LSHFT S,       &hm LCTRL T,       &hm LALT N,        &hm LGUI B,        \
&lt U_BUTTON J,    &hm RALT SLASH,    &kp COMMA,         &kp K,             &lt U_FUN SQT,     &lt U_MEDIA W,     &kp M,             &kp L,             &hm RALT P,        &lt U_BUTTON V,    \
U_NP,              U_NP,              &kp TAB,           &lt U_RNAV E,      &lt U_RBNFRD ESC,  &lt U_RNSYM RET,   &lt U_RPUNC SPC,   &lt U_RBRAC BSPC,  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAK \
&kp Q,             &kp W,             &kp F,             &kp P,             &kp G,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT,           \
&hm LGUI A,        &hm LALT R,        &hm LCTRL S,       &hm LSHFT T,       &kp D,             &kp H,             &hm LSHFT N,       &hm LCTRL E,       &hm LALT I,        &hm LGUI O,        \
&lt U_BUTTON Z,    &hm RALT X,        &kp C,             &kp V,             &lt U_FUN B,       &lt U_MEDIA K,     &kp M,             &kp COMMA,         &hm RALT DOT,      &lt U_BUTTON SLASH,\
U_NP,              U_NP,              &kp TAB,           &lt U_RNAV E,      &lt U_RBNFRD ESC,  &lt U_RNSYM RET,   &lt U_RPUNC SPC,   &lt U_RBRAC BSPC,  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAKDH \
&kp Q,             &kp W,             &kp F,             &kp P,             &kp B,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT,           \
&hm LGUI A,        &hm LALT R,        &hm LCTRL S,       &hm LSHFT T,       &kp G,             &kp M,             &hm LSHFT N,       &hm LCTRL E,       &hm LALT I,        &hm LGUI O,        \
&lt U_BUTTON Z,    &hm RALT X,        &kp C,             &kp D,             &lt U_FUN V,       &lt U_MEDIA K,     &kp H,             &kp COMMA,         &hm RALT DOT,      &lt U_BUTTON SLASH,\
U_NP,              U_NP,              &kp TAB,           &lt U_RNAV E,      &lt U_RBNFRD ESC,  &lt U_RNSYM RET,   &lt U_RPUNC SPC,   &lt U_RBRAC BSPC,  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAKDHK \
&kp Q,             &kp W,             &kp F,             &kp P,             &kp B,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT,           \
&hm LGUI A,        &hm LALT R,        &hm LCTRL S,       &hm LSHFT T,       &kp G,             &kp K,             &hm LSHFT N,       &hm LCTRL E,       &hm LALT I,        &hm LGUI O,        \
&lt U_BUTTON Z,    &hm RALT X,        &kp C,             &kp D,             &lt U_FUN V,       &lt U_MEDIA M,     &kp H,             &kp COMMA,         &hm RALT DOT,      &lt U_BUTTON SLASH,\
U_NP,              U_NP,              &kp TAB,           &lt U_RNAV E,      &lt U_RBNFRD ESC,  &lt U_RNSYM RET,   &lt U_RPUNC SPC,   &lt U_RBRAC BSPC,  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_DVORAK \
&kp SQT,           &kp COMMA,         &kp DOT,           &kp P,             &kp Y,             &kp F,             &kp G,             &kp C,             &kp R,             &kp L,             \
&hm LGUI A,        &hm LALT O,        &hm LCTRL E,       &hm LSHFT U,       &kp I,             &kp D,             &hm LSHFT H,       &hm LCTRL T,       &hm LALT N,        &hm LGUI S,        \
&lt U_BUTTON SLASH,&hm RALT Q,        &kp J,             &kp K,             &lt U_FUN X,       &lt U_MEDIA B,     &kp M,             &kp W,             &hm RALT V,        &lt U_BUTTON Z,    \
U_NP,              U_NP,              &kp TAB,           &lt U_RNAV E,      &lt U_RBNFRD ESC,  &lt U_RNSYM RET,   &lt U_RPUNC SPC,   &lt U_RBRAC BSPC,  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_HALMAK \
&kp W,             &kp L,             &kp R,             &kp B,             &kp Z,             &kp SQT,           &kp Q,             &kp U,             &kp D,             &kp J,             \
&hm LGUI S,        &hm LALT H,        &hm LCTRL N,       &hm LSHFT T,       &kp COMMA,         &kp DOT,           &hm LSHFT A,       &hm LCTRL E,       &hm LALT O,        &hm LGUI I,        \
&lt U_BUTTON F,    &hm RALT M,        &kp V,             &kp C,             &lt U_FUN SLASH,   &lt U_MEDIA G,     &kp P,             &kp X,             &hm RALT K,        &lt U_BUTTON Y,    \
U_NP,              U_NP,              &kp TAB,           &lt U_RNAV E,      &lt U_RBNFRD ESC,  &lt U_RNSYM RET,   &lt U_RPUNC SPC,   &lt U_RBRAC BSPC,  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_WORKMAN \
&kp Q,             &kp D,             &kp R,             &kp W,             &kp B,             &kp J,             &kp F,             &kp U,             &kp P,             &kp SQT,           \
&hm LGUI A,        &hm LALT S,        &hm LCTRL H,       &hm LSHFT T,       &kp G,             &kp Y,             &hm LSHFT N,       &hm LCTRL E,       &hm LALT O,        &hm LGUI I,        \
&lt U_BUTTON Z,    &hm RALT X,        &kp M,             &kp C,             &lt U_FUN V,       &lt U_MEDIA K,     &kp L,             &kp COMMA,         &hm RALT DOT,      &lt U_BUTTON SLASH,\
U_NP,              U_NP,              &kp TAB,           &lt U_RNAV E,      &lt U_RBNFRD ESC,  &lt U_RNSYM RET,   &lt U_RPUNC SPC,   &lt U_RBRAC BSPC,  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_QWERTY \
&kp Q,             &kp W,             &kp E,             &kp R,             &kp T,             &kp Y,             &kp U,             &kp I,             &kp O,             &kp P,             \
&hm LGUI A,        &hm LALT S,        &hm LCTRL D,       &hm LSHFT F,       &kp G,             &kp H,             &hm LSHFT J,       &hm LCTRL K,       &hm LALT L,        &hm LGUI SQT,      \
&lt U_BUTTON Z,    &hm RALT X,        &kp C,             &kp V,             &lt U_FUN B,       &lt U_MEDIA N,     &kp M,             &kp COMMA,         &hm RALT DOT,      &lt U_BUTTON SLASH,\
U_NP,              U_NP,              &kp TAB,           &lt U_RNAV E,      &lt U_RBNFRD ESC,  &lt U_RNSYM RET,   &lt U_RPUNC SPC,   &lt U_RBRAC BSPC,  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_QWERTZ \
&kp Q,             &kp W,             &kp E,             &kp R,             &kp T,             &kp Z,             &kp U,             &kp I,             &kp O,             &kp P,             \
&hm LGUI A,        &hm LALT S,        &hm LCTRL D,       &hm LSHFT F,       &kp G,             &kp H,             &hm LSHFT J,       &hm LCTRL K,       &hm LALT L,        &hm LGUI SQT,      \
&lt U_BUTTON Y,    &hm RALT X,        &kp C,             &kp V,             &lt U_FUN B,       &lt U_MEDIA N,     &kp M,             &kp COMMA,         &hm RALT DOT,      &lt U_BUTTON SLASH,\
U_NP,              U_NP,              &kp TAB,           &lt U_RNAV E,      &lt U_RBNFRD ESC,  &lt U_RNSYM RET,   &lt U_RPUNC SPC,   &lt U_RBRAC BSPC,  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_RSTHP \
&tog U_RIGHTY,     &kp LSHFT,         &kp LALT,          &kp LGUI,          &kp K,             &lt U_MEDIA Z,     &kp L,             &kp COMMA,         &kp U,             &kp Q,             \
&hm LGUI R,        &hm LALT S,        &hm LCTRL T,       &hm LSHFT H,       &kp P,             &kp W,             &hm LSHFT N,       &hm LCTRL A,       &hm LALT I,        &hm LGUI O,        \
&kp LCTRL,         &mo U_RIGHTY,      &kp G,             &kp D,             &lt U_FUN B,       &kp X,             &kp M,             &kp DOT,           &hm RALT DEL,      &sl U_RIGHTY,\
U_NP,              U_NP,              &kp TAB,           &lt U_RNAV E,      &lt U_RBNFRD ESC,  &lt U_RNSYM RET,   &lt U_RPUNC SPC,   &lt U_RBRAC BSPC,  U_NP,              U_NP
...
&u_bootloader,     &to U_TAP,         &to U_EXTRA,       &to U_BASE,        U_NA,              &u_rgb_tog,        &u_bt_sel_4,        &u_rgb_hui,        &u_rgb_sai,        &u_rgb_bri,        \
&kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         U_NA,              &u_out_tog,         &kp C_PREV,        &kp C_VOL_DN,      &kp C_VOL_UP,      &kp C_NEXT,        \
U_NA,              &kp RALT,          &to U_FUN,         &to U_MEDIA,       U_NA,              &bt BT_CLR,        &u_bt_sel_0,       &u_bt_sel_1,       &u_bt_sel_2,       &u_bt_sel_3,       \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              &kp C_STOP,        &kp C_PP,          &kp C_MUTE,        U_NP,              U_NP
...
U_NU,              U_NU,              U_NU,              U_NU,              U_NU,              &u_caps_word,      &kp LEFT,          &kp DOWN,          &kp UP,            &kp RIGHT,         \
U_NU,              U_NU,              U_NU,              U_NU,              U_NU,              &kp INS,           &kp HOME,          &kp PG_DN,         &kp PG_UP,         &kp END,           \
